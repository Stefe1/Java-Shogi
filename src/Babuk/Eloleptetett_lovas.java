...
public class Eloleptetett_lovas extends Babu{
	public Eloleptetett_lovas(int sor, int oszlop, boolean feher, Kep_beolvaso kep_hash,Tabla jatekter) {
		super(sor, oszlop, feher,kep_hash,"eloleptetett_lovas",jatekter);
	}
	//típus lekérdezése
	public String tipus_lekerdezes() {
		return "eloleptetett_lovas";
	}
	...
	public void leutve() {
		this.jatekter.leutott_lekerdezes().hozzadas(!this.feher, "lovas");
	}
}
