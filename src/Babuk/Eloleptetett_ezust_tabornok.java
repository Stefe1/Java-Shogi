...
public class Eloleptetett_ezust_tabornok extends Babu {
	public Eloleptetett_ezust_tabornok(int sor, int oszlop, boolean feher, Kep_beolvaso kep_hash,Tabla jatekter) {
		super(sor, oszlop, feher,kep_hash,"eloleptetett_ezust_tabornok",jatekter);
	}
	//típus lekérdezése
	public String tipus_lekerdezes() {
		return "eloleptetett_ezust_tabornok";
	}
	...
	public void leutve() {
		this.jatekter.leutott_lekerdezes().hozzadas(!this.feher, "ezust_tabornok");
	}
}
